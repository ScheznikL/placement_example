...
class ChatScreenViewModel(
    private val chatRepository: ChatRepo, private val modelRoomRepo: ModelsRepo
) : ViewModel() {
    ...
    private fun extractFullDescription(assistantMessage: String): String =
        if (!assistantMessage.contains(specificIsMarker)) assistantMessage.substringAfter(markerPhrase) else assistantMessage.substringAfter(
            deviantMarkerPhrase
        )
